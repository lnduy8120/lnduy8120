          ...
          <div className="flex flex-col md:flex-row">
             ...
             <div className="w-full md:w-3/5 p-6 md:p-8 flex flex-col justify-between">
                ...
                <div className="flex flex-col sm:flex-row gap-4 mt-auto">
                   <button className="flex-1 bg-primary hover:bg-green-400 text-background-dark h-12 rounded-lg font-bold text-base transition-all transform hover:-translate-y-0.5 active:translate-y-0 shadow-[0_4px_14px_0_rgba(19,236,91,0.39)] flex items-center justify-center gap-2 group/btn">
                      <Icon name="download" className="group-hover/btn:animate-bounce" />
                      Download PDF
                   </button>
                   <button className="flex-1 bg-transparent hover:bg-surface-border/30 text-white border border-surface-border hover:border-primary/50 h-12 rounded-lg font-medium text-base transition-all flex items-center justify-center gap-2 font-mono">
