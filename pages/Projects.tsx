        ...
        <div className="flex flex-wrap gap-2 justify-end">
          {['All', 'Spring Boot', 'Microservices', 'JavaFX', 'Cloud'].map(cat => (
            <button
              ...
              className={`px-3 py-1.5 rounded-md text-sm font-mono transition-all ${filter === cat
            ...
            <div className="flex flex-col p-6 flex-grow">
              ...
              <div className="flex gap-3 mt-auto pt-4 border-t border-zinc-800">
                <a
                  ...
                  className="flex-1 flex items-center justify-center gap-2 h-10 px-4 bg-primary text-black rounded font-bold text-sm hover:bg-white transition-colors"
                >
                ...
                {project.demoUrl && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex-1 flex items-center justify-center gap-2 h-10 px-4 bg-transparent border border-primary text-primary rounded font-bold text-sm hover:bg-primary/10 transition-colors"
                  >
      ...
      {/* <div className="mt-6 group flex flex-col md:flex-row bg-black border border-zinc-800 rounded-lg overflow-hidden">
        ...
        <div className="w-full md:w-[350px] bg-zinc-900 p-6 flex flex-col justify-center border-t md:border-t-0 md:border-l border-zinc-800">
          ...
          <button
            ...
            className="w-full py-2 bg-zinc-800 text-white hover:bg-primary hover:text-black rounded font-mono text-sm font-bold transition-colors"
          >
            View Architecture
          </button>
        </div>
